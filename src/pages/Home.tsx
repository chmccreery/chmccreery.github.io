...
export function HomePage() {
  return (
    <Grid gutter="xl">
      ...
      <Grid.Col sm={12} lg={8}>
        <Text>
          Hi, and welcome to my website! My name is Clara and I am a senior software engineer at&nbsp;r2c,
        ...
        <Text>
          ...
          was a research position at MIT Lincoln Laboratory&nbsp;(MITLL) investigating ways to prevent and mitigate chemical and biological 
          attacks.
        </Text>
        <Space h={paragraphSpacing}/>
        <Text>
          I loved many parts of this job (my team, the mission, the travel, my team), 
          but I did not have the patience for lab work. I had done just enough computer science to appreciate
          how much more efficient I could be if I programmed a computer to do the repetitive tasks 
          in the lab for me.
        ...
        <Space h={paragraphSpacing}/>
        <Text>
          I interviewed with r2c - one of the few companies in silicon valley where people knew what MITLL was - 
